package com.hengtacc.object.storage.core.exceptions;

/**
 * 文件包装器异常
 *
 * @author Kuang HaiBo 2023/10/30 17:17
 */
public class FileWrapperException extends ObjectStorageException {
	 ...
	 * @since 1.4
	 */
	public FileWrapperException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public FileWrapperException(Throwable cause) {
		super(cause);
	}
