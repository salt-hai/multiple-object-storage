 ...
 * 文件获取异常
 *
 * @author Kuang HaiBo 2023/10/26 16:47
 */

public class GetFileException extends ObjectStorageException {
	 ...
	 * @return 异常
	 */
	public static GetFileException noFound(String objectKey) {
		return new GetFileException(objectKey + ":noFound");
	}
