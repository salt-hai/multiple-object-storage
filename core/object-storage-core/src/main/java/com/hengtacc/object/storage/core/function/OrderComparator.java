...
/**
 * <p>
 * 对{@link Ordered }子类进行排序, {@link Ordered#getOrder()} 越小 优先级越高
 * </p>
 *
 * @author Kuang HaiBo 2023/11/21 14:55
 */
public class OrderComparator implements Comparator<Ordered> {
	 ...
	 * designates the mathematical <i>signum</i> function, which is defined to return one
	 * of <tt>-1</tt>, <tt>0</tt>, or <tt>1</tt> according to whether the value of
	 ...
	 * <tt>(compare(x, y)==0) == (x.equals(y))</tt>. Generally speaking, any comparator
	 * that violates this condition should clearly indicate this fact. The recommended
	 * language is "Note: this comparator imposes orderings that are inconsistent with
	 * equals."
