...
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToAbortMultipartUploadRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToCompleteMultipartUploadRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToInitiateMultipartUploadRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToListMultipartUploadsRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToListPartsRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToUploadPartCopyRequestConverter;
import com.hengtacc.object.storage.baidu.converter.arguments.ArgumentToUploadPartRequestConverter;
import com.hengtacc.object.storage.baidu.converter.domain.CompleteMultipartUploadResponseToDomainConverter;
import com.hengtacc.object.storage.baidu.converter.domain.InitiateMultipartUploadResponseToDomainConverter;
import com.hengtacc.object.storage.baidu.converter.domain.ListMultipartUploadsResponseToDomainConverter;
import com.hengtacc.object.storage.baidu.converter.domain.ListPartsResponseToDomainConverter;
import com.hengtacc.object.storage.baidu.converter.domain.UploadPartCopyResponseToDomainConverter;
import com.hengtacc.object.storage.baidu.converter.domain.UploadPartResponseToDomainConverter;
...
public class BosObjectMultipartOperations extends BaseBosOperations implements ObjectMultipartOperations {
	 ...
	 * {@link com.hengtacc.object.storage.core.arguments.multipart.UploadPartArguments}
