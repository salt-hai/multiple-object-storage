...
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToCopyObjectRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToDeleteObjectRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToGetObjectMetadataArgumentsConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToGetObjectRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToListObjectsRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToObjectDoesExistRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToSetObjectAclRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentsToDeleteObjectsRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentsToPutObjectRequestConverter;
import com.hengtacc.object.storage.huawei.converter.domain.DeleteObjectsResultToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.ObjectListingToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.ObjectMetadataToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.ObsObjectToGetObjectDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.PutObjectResultToDomainConverter;
