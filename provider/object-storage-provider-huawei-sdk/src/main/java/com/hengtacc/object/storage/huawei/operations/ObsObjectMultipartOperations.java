package com.hengtacc.object.storage.huawei.operations;

import com.hengtacc.object.storage.core.arguments.multipart.AbortMultipartUploadArguments;
import com.hengtacc.object.storage.core.arguments.multipart.CompleteMultipartUploadArguments;
import com.hengtacc.object.storage.core.arguments.multipart.InitiateMultipartUploadArguments;
...
import com.hengtacc.object.storage.core.domain.multipart.AbortMultipartUploadDomain;
...
import com.hengtacc.object.storage.huawei.BaseObsOperations;
import com.hengtacc.object.storage.huawei.ObsConstants;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToAbortMultipartUploadRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToCopyPartRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToInitiateMultipartUploadRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToListMultipartUploadsRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToListPartsRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentToUploadPartRequestConverter;
import com.hengtacc.object.storage.huawei.converter.arguments.ArgumentsToCompleteMultipartUploadRequestConverter;
import com.hengtacc.object.storage.huawei.converter.domain.CompleteMultipartUploadResultToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.CopyPartResultToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.InitiateMultipartUploadResultToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.ListPartsResultToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.MultipartUploadListingToDomainConverter;
import com.hengtacc.object.storage.huawei.converter.domain.UploadPartResultToDomainConverter;
